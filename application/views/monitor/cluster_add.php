...
<form class="form-horizontal">
    ...
    <div class="control-group">
        ...
        <div class="controls">
        <input class="input-xlarge focused" id="clustername" name="clustername" type="text" value="" required>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label">Server List</label>
        <div class="controls">
        <input class="input-xlarge" id="serverlist" placeholder="192.168.1.1:2181,192.168.1.1:2181" name="serverlist" type="text" value="" required>
        </div>
    </div>
    <div class="control-group">
        <div class="span3"></div>
